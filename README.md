...
Scripts, snippets, and config files for the JWST data reduction section. A lot built upon the work from the 2023 Sagan Summer Workshop and related notebooks (see details [here](https://nexsci.caltech.edu/workshop/2023/)).
...
- [Stage 6](https://nasa-ext.box.com/shared/static/xyx8cqhz8oavqw361upw68zsu4tw6db0.gz)
